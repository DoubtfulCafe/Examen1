    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a href="{{ route('directorio.init') }}" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</a>          
          <a href="{{ route('directorio.destroy') }}" class="btn btn-danger" data-bs-dismiss="modal">Confirmar</a>          
        </div>
      </div>
    </div>
